...
public class Fisica
{
    ...
    public static void ouvirTimbre(Timbre timbre, String caminhoArquivo, double taxaAmostragem, double duracao) throws IOException, UnsupportedAudioFileException{
